...
export default function DoctorAuth({ onRoleChange, onLogin }) {
  ...
  try {
    ...
    console.log("Doctor auth success:", data);

    // store role if you use protected routes
    localStorage.setItem("role", "doctor");

    onLogin(); // redirect to doctor dashboard
  } catch (error) {
